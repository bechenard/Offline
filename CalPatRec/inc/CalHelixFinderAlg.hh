...
//-----------------------------------------------------------------------------
    ...
    void  setCalorimeter(const Calorimeter* Cal    ) {
      _calorimeter = Cal;
      fCaloOffset = (_calorimeter->G4Info().getDouble("diskCaseZLength")/2.
                     + (  _calorimeter->G4Info().getDouble("BPPipeZOffset")
                        + _calorimeter->G4Info().getDouble("BPHoleZLength")
                        + _calorimeter->G4Info().getDouble("FEEZLength"))/2.
                     - _calorimeter->G4Info().getDouble("FPCarbonZLength") - _calorimeter->G4Info().getDouble("FPFoamZLength")
                     );
    }
//-----------------------------------------------------------------------------
// diagnostics
