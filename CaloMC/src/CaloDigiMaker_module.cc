...
namespace mu2e {
                                       ...
                                       const ProtonBunchTimeMC& pbtmc)
  {
      ...
      if (calorimeter_->nCrystals()<1 || calorimeter_->G4Info().getInt("nSiPMPerCrystal")<1) return;
      ...
      int nWaveforms   = calorimeter_->nCrystals()*calorimeter_->G4Info().getInt("nSiPMPerCrystal");
