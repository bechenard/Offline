...
void RobustHelixFit::findAGE(RobustHelixFinderData const& HelixData, XYZVectorF const& center,float& rmed, float& age)
{
  ...
  if(_usecc && HelixData._hseed.caloCluster().isNonnull())
  {
    ...
    XYZVectorF cog(_calorimeter->caloUtil().mu2eToTracker(_calorimeter->caloUtil().diskFFToMu2e(HelixData._hseed.caloCluster()->diskID(),HelixData._hseed.caloCluster()->cog3Vector())));
